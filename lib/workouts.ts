...
export const WORKOUTS: Workout[] = [
  ...
  // ── Strength Endurance: Dumbbell ────────────────────────────────────────────────
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Dumbbell Push-Up to Row", category: "push", sets: 4, notes: "Place dumbbells on the floor, grip them, and do a push-up. At the top, row one dumbbell up to your hip, set it down, then row the other. That's one rep. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=push+up+to+row+dumbbell+beginner", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
