export type Exercise = {
  ...
  /** Whether this movement uses external load (shows a weight input). */
  is_weighted?: boolean;
  /** Whether this movement is performed one side at a time (per-side logging). */
  is_unilateral?: boolean;
  /** How a set is measured: rep count, hold time, or distance/carry. */
...
export const WORKOUTS: Workout[] = [
  ...
  // ── Strength Endurance: Bodyweight ──────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: "e1", name: "Push-Ups", category: "push", sets: 4, notes: "Lower your chest to the floor, then push back up. If this is too hard, start with your knees on the ground — that's totally fine. Go until you can't do another one with good form.", videoUrl: "https://www.youtube.com/results?search_query=push+up+proper+form+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Inverted Row", category: "pull", sets: 4, notes: "Find a sturdy bar at waist-to-chest height (~3–4 ft) — stair handrails, low playground rails, a squat rack bar set low. Lie underneath, grip the bar with arms extended, pull your chest up to the bar.", videoUrl: "https://www.youtube.com/results?search_query=inverted+row+at+home+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Bodyweight Squats", category: "legs", sets: 4, notes: "Stand with feet shoulder-width apart. Bend your knees and lower your hips like you're sitting into a chair until your thighs are parallel to the floor, then stand back up. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=bodyweight+squat+form+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Dead Bug", category: "core", sets: 4, notes: "Lie on your back, arms pointing at the ceiling, knees bent at 90 degrees. Slowly lower your right arm behind your head and your left leg toward the floor at the same time. Return and switch sides. Keep your lower back pressed into the floor the entire time. Go until you can't maintain good form.", videoUrl: "https://www.youtube.com/results?search_query=dead+bug+exercise+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
    ],
  },
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Decline Push-Ups (feet on bench)", category: "push", sets: 4, notes: "Put your feet up on a park bench, hands on the ground, and do push-ups. This makes your chest and shoulders work harder than regular push-ups. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=decline+push+ups+form+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Inverted Row", category: "pull", sets: 4, notes: "Find a sturdy bar at waist-to-chest height (~3–4 ft) — stair handrails, low playground rails, a squat rack bar set low. Lie underneath, grip the bar with arms extended, pull your chest up to the bar.", videoUrl: "https://www.youtube.com/results?search_query=australian+pull+ups+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Walking Lunges", category: "legs", sets: 4, notes: "Take a big step forward and lower your back knee until it almost touches the ground, then step the other foot forward and repeat. Keep your chest tall. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=walking+lunge+form+beginner", is_weighted: false, is_unilateral: true, tracking_type: "reps" },
      { id: "e4", name: "Plank Hold", category: "core", sets: 4, notes: "Get into a push-up position but rest on your forearms instead of your hands. Keep your body in a perfectly straight line from head to heels. Hold as long as you can and count the seconds. That's your score to beat next time.", videoUrl: "https://www.youtube.com/results?search_query=plank+hold+proper+form+beginner", is_weighted: false, is_unilateral: false, tracking_type: "time" },
    ],
  },
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Diamond Push-Ups", category: "push", sets: 4, notes: "Make a diamond shape with your hands under your chest and do push-ups. This targets your triceps more than regular push-ups. If too hard, widen your hands a bit. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=diamond+push+ups+form+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Superman Holds", category: "hinge", sets: 4, notes: "Lie face down on the floor. Lift your arms and legs off the ground at the same time, squeezing your back muscles. Hold as long as you can (count seconds), then rest. That's one set.", videoUrl: "https://www.youtube.com/results?search_query=superman+hold+exercise+beginner", is_weighted: false, is_unilateral: false, tracking_type: "time" },
      { id: "e3", name: "Jump Squats", category: "legs", sets: 4, notes: "Do a regular squat, but when you stand up, jump off the ground. Land softly with bent knees. If jumping is too much on your knees, just do fast regular squats. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=jump+squat+form+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Bird Dog", category: "core", sets: 4, notes: "Start on your hands and knees. Extend your right arm forward and left leg back at the same time, keeping your back flat like a table. Hold for 2 seconds, return, switch sides. This trains your core to stabilize while your limbs move.", videoUrl: "https://www.youtube.com/results?search_query=bird+dog+exercise+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
    ],
  },
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Pike Push-Ups", category: "push", sets: 4, notes: "Get into a push-up position but walk your feet toward your hands so your hips are high in the air (like an upside-down V). Now do push-ups in that position — this targets your shoulders. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=pike+push+ups+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Doorway Rows", category: "pull", sets: 4, notes: "Stand in a doorway, grip both sides of the frame at chest height, lean back with feet planted, pull yourself upright. No equipment needed beyond a sturdy doorway.", videoUrl: "https://www.youtube.com/results?search_query=doorframe+rows+exercise", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Bulgarian Split Squat", category: "legs", sets: 4, notes: "Back foot elevated on a bench, step, or low wall. Front foot 2–3 feet forward. Lower until back knee nearly touches the ground, drive through front heel to stand.", videoUrl: "https://www.youtube.com/results?search_query=bodyweight+bulgarian+split+squat+beginner", is_weighted: false, is_unilateral: true, tracking_type: "reps" },
      { id: "e4", name: "Flutter Kicks", category: "core", sets: 4, notes: "Lie on your back, hands under your hips for support. Lift both legs a few inches off the floor and kick them up and down in small, alternating motions. Keep your lower back pressed into the floor. Go until you can't maintain form.", videoUrl: "https://www.youtube.com/results?search_query=flutter+kicks+exercise+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
    ],
  },
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Incline Push-Ups (hands on bench)", category: "push", sets: 4, notes: "Place your hands on the bench, feet on the ground, and do push-ups. This is easier than floor push-ups — a great starting point if regular push-ups are too hard. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=incline+push+ups+bench+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Picnic Table Rows", category: "pull", sets: 4, notes: "Lie on your back beneath the edge of a picnic table. Reach up and grip the edge of the tabletop with both hands. Pull your chest up toward the table edge. If no picnic table is available, find a sturdy low bar at waist-to-chest height (stair handrail, low playground rail).", videoUrl: "https://www.youtube.com/results?search_query=inverted+row+park+bench", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Step-Ups (on bench)", category: "legs", sets: 4, notes: "Step one foot up onto the bench, drive through that leg to stand on top, then step back down. Alternate legs. Keep your chest tall. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=bench+step+ups+beginner", is_weighted: false, is_unilateral: true, tracking_type: "reps" },
  ...
  },
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Push-Ups", category: "push", sets: 4, notes: "Hands shoulder-width apart, lower your chest to the floor, push back up. The most fundamental upper body exercise there is. On your knees if needed. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=push+up+proper+form+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Pull-Ups", category: "pull", sets: 4, notes: "Hang from a sturdy overhead bar with palms facing away. Pull until chin clears the bar, lower with control. Use band, box-assisted, or assisted pull-up machine if needed.", videoUrl: "https://www.youtube.com/results?search_query=pull+up+beginner+progression", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Bodyweight Lunges", category: "legs", sets: 4, notes: "Step forward into a lunge — front thigh parallel to the floor, back knee almost touching the ground. Push back to standing. Alternate legs. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=bodyweight+lunge+proper+form+beginner", is_weighted: false, is_unilateral: true, tracking_type: "reps" },
      { id: "e4", name: "Plank Hold", category: "core", sets: 4, notes: "Forearms on the floor, body straight as a board from head to heels. Hold as long as you can. Don't let your hips sag. Count the seconds — that's your score.", videoUrl: "https://www.youtube.com/results?search_query=plank+hold+proper+form+beginner", is_weighted: false, is_unilateral: false, tracking_type: "time" },
    ],
  },
  ...
  // ── Strength Endurance: Household ───────────────────────────────────────────────
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Sandbag Floor Press", category: "push", sets: 4, notes: "Lie on your back on the floor, hold the sandbag on your chest, and press it straight up until your arms are extended. Lower it back to your chest. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=sandbag+floor+press", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Sandbag Bent-Over Row", category: "pull", sets: 4, notes: "Stand with feet shoulder-width apart, bend forward at the hips (flat back), and pull the sandbag from the floor up to your belly button. Squeeze your shoulder blades together at the top. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=sandbag+bent+over+row", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Sandbag Goblet Squats", category: "legs", sets: 4, notes: "Hug the sandbag to your chest like you're holding a big goblet. Squat down keeping your chest tall, then stand back up. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=goblet+squat+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Sandbag Russian Twist", category: "core", sets: 4, notes: "Sit on the floor with knees bent, holding the sandbag at your chest. Lean back slightly so you feel your abs engage. Rotate your torso to touch the bag to the floor on your left, then your right. That's one rep.", videoUrl: "https://www.youtube.com/results?search_query=russian+twist+exercise+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
    ],
  },
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Kid Overhead Press", category: "push", sets: 4, notes: "Hold your kid at chest height and press them straight up overhead, then bring them back down. They'll love it. You'll feel it in your shoulders. Go until you can't do another one. Best for kids 20–50 lbs. Use a soft surface (carpet, mat, grass) underneath. Don't press if your child is too heavy to control safely overhead.", videoUrl: "https://www.youtube.com/results?search_query=overhead+press+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Kid-on-Back Rows", category: "pull", sets: 4, notes: "Get into a push-up position with your kid sitting on your back. With one hand, grab a jug of water or heavy bag and row it up to your hip. Switch arms each set. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=renegade+row+form+beginner", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
      { id: "e3", name: "Kid Squat & Toss", category: "legs", sets: 4, notes: "Hold your kid at your chest, squat down, stand up, and give them a gentle toss in the air. Giggles are your bonus reps. Go until you can't do another one. Best for kids 20–50 lbs. Toss only to a height you can reliably catch. Soft surface underneath. Stop immediately if your child seems uncomfortable.", videoUrl: "https://www.youtube.com/results?search_query=goblet+squat+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Sandbag Sit-Up", category: "core", sets: 4, notes: "Lie on your back holding the sandbag on your chest. Do a sit-up, keeping the bag pressed to your chest the whole time. The extra weight makes your abs work much harder. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=weighted+sit+up+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
    ],
  },
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Bucket Floor Press", category: "push", sets: 4, notes: "Lie on the floor holding a bucket handle in each hand at chest level. Press them straight up, then lower. If buckets are awkward, use one bucket held with both hands. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=floor+press+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Bucket Rows", category: "pull", sets: 4, notes: "Bend forward at the hips, grab a bucket in each hand, and pull them up to your hips. Squeeze your shoulder blades together at the top. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=bent+over+row+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Bucket Farmer Carry Lunges", category: "legs", sets: 4, notes: "Hold a bucket in each hand at your sides. Do walking lunges across your yard. The buckets make it harder to balance, which is the point. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=farmer+carry+lunges+beginner", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
  ...
  },
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Chair Dips", category: "push", sets: 4, notes: "Sit on the edge of a sturdy chair. Place your hands on the edge, slide your butt off, and lower yourself by bending your elbows. Push back up. This works your triceps. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=chair+dips+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Door-Anchored Towel Rows", category: "pull", sets: 4, notes: "Loop a towel through the top of a closed, sturdy door. Hold both ends, lean back with feet planted, pull yourself upright.", videoUrl: "https://www.youtube.com/results?search_query=towel+row+exercise", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Wall Sit", category: "legs", sets: 4, notes: "Stand with your back against a wall, slide down until your thighs are parallel to the floor. Hold as long as you can. Count seconds — that's your score to beat. Bodyweight only — needs a wall. Lean against the wall with knees bent at 90 degrees, hold for time.", videoUrl: "https://www.youtube.com/results?search_query=wall+sit+form", is_weighted: false, is_unilateral: false, tracking_type: "time" },
      { id: "e4", name: "Sandbag Sit-Up", category: "core", sets: 4, notes: "Lie on your back holding the sandbag on your chest. Do a sit-up, keeping the bag pressed to your chest the whole time. The extra weight makes your abs work much harder. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=weighted+sit+up+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
    ],
  },
  ...
  // ── Strength Endurance: Kettlebell ──────────────────────────────────────────────
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Kettlebell Push Press", category: "push", sets: 4, notes: "Hold the kettlebell at your shoulder. Dip your knees slightly, then use that momentum to press the bell overhead. Do one arm at a time. Go until you can't do another one, then switch arms.", videoUrl: "https://www.youtube.com/results?search_query=kettlebell+push+press+form+beginner", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
      { id: "e2", name: "Kettlebell Single-Arm Row", category: "pull", sets: 4, notes: "Put one hand on a chair or bench for support, hold the kettlebell in the other hand, and pull it up to your hip. Keep your back flat. Go until you can't do another one, then switch arms.", videoUrl: "https://www.youtube.com/results?search_query=kettlebell+single+arm+row+beginner", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
      { id: "e3", name: "Kettlebell Goblet Squat", category: "legs", sets: 4, notes: "Hold the kettlebell by the handle (horns) at your chest. Squat down, letting your elbows touch the inside of your knees at the bottom. Stand back up. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=kettlebell+goblet+squat+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "KB Turkish Get-Up (half)", category: "core", sets: 4, notes: "Lie on your back holding a kettlebell straight up with one arm. Keeping the bell pointed at the ceiling, sit up onto your opposite elbow, then your hand, then lift your hips. That's half a get-up. Reverse the steps back down. Do 3-5 per arm.", videoUrl: "https://www.youtube.com/results?search_query=half+turkish+get+up+beginner", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
    ],
  },
  {
  ...
  // ── Strength Endurance: Dumbbell ────────────────────────────────────────────────
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Dumbbell Push-Up to Row", category: "push", sets: 4, notes: "Place dumbbells on the floor, grip them, and do a push-up. Set your feet wider than your hips for stability. At the top, row one dumbbell up to your hip, set it down, then row the other. That's one rep. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=push+up+to+row+dumbbell+beginner", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
      { id: "e2", name: "Dumbbell Bent-Over Row", category: "pull", sets: 4, notes: "Hold a dumbbell in each hand. Bend forward at the hips (flat back, slight knee bend). Pull both dumbbells up to your hips, squeezing your shoulder blades together. Lower and repeat. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=dumbbell+bent+over+row+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Dumbbell Step-Ups", category: "legs", sets: 4, notes: "Hold dumbbells at your sides. Step one foot up onto a sturdy chair, bench, or step, driving through that leg to stand up on top. Step back down. Alternate legs. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=dumbbell+step+ups+form+beginner", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
      { id: "e4", name: "Dumbbell Farmer's Carry", category: "core", sets: 4, notes: "Hold a heavy dumbbell in each hand at your sides. Walk slowly for 30-40 yards (or 30 seconds) with perfect posture — chest up, shoulders back, core tight. This looks easy but your entire core is working. That's one set.", videoUrl: "https://www.youtube.com/results?search_query=farmers+carry+exercise+beginner", is_weighted: true, is_unilateral: false, tracking_type: "distance" },
    ],
  },
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Dumbbell Overhead Press", category: "push", sets: 4, notes: "Hold dumbbells at shoulder height, palms facing forward. Press straight up overhead. Lower with control. Use light weight — this is about reps, not heavy lifting. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=dumbbell+shoulder+press+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Dumbbell Reverse Fly", category: "pull", sets: 4, notes: "Bend forward at the hips. Hold dumbbells hanging below you. Raise your arms out to the sides like you're spreading wings. Squeeze your upper back. Use light weight. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=dumbbell+reverse+fly+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Dumbbell Goblet Squat", category: "legs", sets: 4, notes: "Hold one dumbbell vertically at your chest with both hands, like a goblet. Squat down keeping your chest tall. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=dumbbell+goblet+squat+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Dumbbell Renegade Row Plank", category: "core", sets: 4, notes: "Get into a push-up position holding dumbbells. Without rowing, just hold the plank position for 30-60 seconds. The narrow, unstable base forces your core to work overtime. If you want more challenge, slowly row one dumbbell at a time.", videoUrl: "https://www.youtube.com/results?search_query=renegade+row+plank+beginner", is_weighted: true, is_unilateral: false, tracking_type: "time" },
    ],
  },
  {
    id: "se-db-3", name: "Dumbbell Grinder", type: "strength-endurance", equipment: "dumbbell",
    description: "Four classic moves. Light weight. Maximum reps. Full body burn.",
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Dumbbell Floor Fly", category: "push", sets: 4, notes: "Lie on the floor with a dumbbell in each hand, arms extended above your chest. Lower your arms out to the sides in a wide arc until your elbows touch the floor, then bring them back together. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=dumbbell+floor+fly+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Dumbbell High Pull", category: "pull", sets: 4, notes: "Hold DBs at hips. Pull straight up to chest height by leading with elbows, keeping DBs close to body. Stop at chest — don't go higher (shoulder impingement risk).", videoUrl: "https://www.youtube.com/results?search_query=dumbbell+upright+row+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Dumbbell Sumo Squat", category: "legs", sets: 4, notes: "Stand with feet wide and toes pointed out. Hold one dumbbell with both hands hanging between your legs. Squat down deep, then stand. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=dumbbell+sumo+squat+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
  ...
  // ── Strength Endurance: Full Gym ────────────────────────────────────────────────
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Cable Chest Flyes", category: "push", sets: 4, notes: "Stand between the cable machines, grab a handle in each hand, and bring your hands together in front of your chest in a hugging motion. Use light weight and feel the squeeze. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=cable+chest+fly+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Lat Pulldown", category: "pull", sets: 4, notes: "Sit at the lat pulldown machine. Grab the bar wide, pull it down to your upper chest, then slowly let it back up. Think about pulling with your back, not your arms. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=lat+pulldown+proper+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Leg Press", category: "legs", sets: 4, notes: "Sit in the leg press machine, feet shoulder-width on the platform. Push the weight up by extending your legs, then slowly lower it back. Don't lock your knees at the top. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=leg+press+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Cable Pallof Press", category: "core", sets: 4, notes: "Stand sideways to a cable machine with the handle at chest height. Hold it at your chest with both hands, then press it straight out in front of you. The cable is trying to twist you — resist it. Hold for 2 seconds, return. Do 8-10 per side.", videoUrl: "https://www.youtube.com/results?search_query=pallof+press+beginner", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
    ],
  },
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Sled Push", category: "push", sets: 4, notes: "Load a sled with moderate weight. Grab the low handles, lean in, and push it across the floor by driving with your legs. Push for 30-40 yards or 30 seconds. That's one set. Rest 60-90 seconds between sets.", videoUrl: "https://www.youtube.com/results?search_query=sled+push+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "distance" },
      { id: "e2", name: "Sled Pull (rope)", category: "pull", sets: 4, notes: "Attach a rope to the sled. Face it, sit your hips back, and pull the sled toward you hand-over-hand. When it reaches you, push it back and repeat. One trip = one set.", videoUrl: "https://www.youtube.com/results?search_query=sled+rope+pull+beginner", is_weighted: true, is_unilateral: false, tracking_type: "distance" },
      { id: "e3", name: "Landmine Squat", category: "legs", sets: 4, notes: "Put one end of a barbell in the landmine holder. Hold the other end at your chest. Squat down and stand back up. The bar path guides your form. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=landmine+squat+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Hanging Knee Raise", category: "core", sets: 4, notes: "Hang from a pull-up bar. Slowly raise your knees toward your chest, pause, then lower with control. Don't swing. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=hanging+knee+raise+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
    ],
  },
  {
    id: "se-gym-3", name: "Cable Cruiser", type: "strength-endurance", equipment: "full-gym",
    description: "The cable machine does everything. Four moves, full body, smooth resistance.",
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Cable Press (low to high)", category: "push", sets: 4, notes: "Set the cable at the lowest position. Grab the handle with one hand and press it up and forward in a scooping motion. Great for upper chest. Go until you can't do another one, then switch arms.", videoUrl: "https://www.youtube.com/results?search_query=low+to+high+cable+press+beginner", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
      { id: "e2", name: "Cable Face Pull", category: "pull", sets: 4, notes: "Set the cable at head height with a rope attachment. Grab the rope and pull it toward your face, spreading the ends apart. Squeeze your upper back. This is one of the best exercises for posture. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=cable+face+pull+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Cable Pull-Through", category: "hinge", sets: 4, notes: "Set the cable at the lowest position. Stand facing away from it, reach between your legs and grab the rope. Stand up by driving your hips forward. This works your glutes and hamstrings. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=cable+pull+through+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
  ...
  },
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Chest Press Machine", category: "push", sets: 4, notes: "Sit in the chest press machine. Adjust the seat so the handles are at chest height. Push the handles forward until your arms are extended, then slowly let them back. Light weight, high reps. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=chest+press+machine+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Seated Row Machine", category: "pull", sets: 4, notes: "Sit at the row machine, grab the handles, and pull them toward your belly. Squeeze your shoulder blades together. Keep your back straight. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=seated+row+machine+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Leg Extension Machine", category: "legs", sets: 4, notes: "Sit in the leg extension machine, tuck your shins behind the pad, and extend your legs until straight. Lower slowly. Light weight — this isolates your quad muscles. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=leg+extension+machine+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Hanging Knee Raise", category: "core", sets: 4, notes: "Hang from a pull-up bar. Slowly raise your knees toward your chest, pause, then lower with control. Don't swing. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=hanging+knee+raise+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
    ],
  },
  {
    ...
    warmup: SE_WARMUP, modifications: SE_MODS,
    exercises: [
      { id: "e1", name: "Chest Press Machine", category: "push", sets: 4, notes: "Adjust the seat so handles are at chest height. Push forward until arms are extended, slowly return. Machines guide the movement so you can focus on effort, not balance. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=chest+press+machine+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Lat Pulldown", category: "pull", sets: 4, notes: "Sit at the pulldown machine, grab the wide bar, pull it to your upper chest. Think about pulling with your back, not your arms. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=lat+pulldown+proper+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Leg Press", category: "legs", sets: 4, notes: "Sit in the machine, feet shoulder-width on the platform. Push until legs are almost straight (don't lock your knees), slowly lower back. Go until you can't do another one.", videoUrl: "https://www.youtube.com/results?search_query=leg+press+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Cable Pallof Press", category: "core", sets: 4, notes: "Stand sideways to the cable machine, handle at chest height. Press it straight out in front of you and resist the cable's pull. Hold 2 seconds, return. Do 8-10 per side.", videoUrl: "https://www.youtube.com/results?search_query=pallof+press+beginner", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
    ],
  },
  ...
  },
  {
    ...
    warmup: SH_WARMUP, modifications: SH_MODS,
    exercises: [
      { id: "e1", name: "Archer Push-Ups", category: "push", sets: 4, notes: "Get in a wide push-up position. As you lower, shift your weight to one arm, straightening the other arm out to the side. Push back up. This is almost a one-arm push-up. Alternate sides. If too hard, do wide push-ups instead. Record reps per set.", videoUrl: "https://www.youtube.com/results?search_query=archer+push+ups+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Backpack Rows", category: "pull", sets: 4, notes: "Load a backpack with books or other weight. Hold by both shoulder straps, hinge at hips into bent-over position, row to lower chest.", videoUrl: "https://www.youtube.com/results?search_query=weighted+inverted+row", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
  ...
  // ── Strength Hypertrophy: Household ─────────────────────────────────────────────
  {
    ...
    warmup: SH_WARMUP, modifications: SH_MODS,
    exercises: [
      { id: "e1", name: "Heavy Sandbag Press", category: "push", sets: 4, notes: "Lift the sandbag to your shoulder, then press it overhead. Use a heavier bag than your endurance day. Aim for 6-10 reps — if you can easily do more than 10, add more rocks or sand next time.", videoUrl: "https://www.youtube.com/results?search_query=sandbag+clean+and+press+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Heavy Sandbag Row", category: "pull", sets: 4, notes: "Same as endurance day but with a heavier bag. Bend at the hips, pull the bag to your belly. Aim for 6-10 reps. If it's easy, make the bag heavier.", videoUrl: "https://www.youtube.com/results?search_query=sandbag+bent+over+row", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Sandbag Zercher Squats", category: "legs", sets: 4, notes: "Hold the sandbag in the crook of your elbows (like cradling a baby). Squat down and stand back up. It's uncomfortable — that means it's working. Aim for 6-10 reps.", videoUrl: "https://www.youtube.com/results?search_query=zercher+squat+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Bucket Suitcase Carry", category: "core", sets: 4, notes: "Hold a weighted bucket in one hand, opposite hand free. Walk forward 20–40 feet maintaining upright posture — fight the urge to lean toward the loaded side. Switch hands for next set. Hits core via anti-lateral flexion.", videoUrl: "https://www.youtube.com/results?search_query=plank+drag+exercise", is_weighted: true, is_unilateral: true, tracking_type: "distance" },
    ],
  },
  {
    ...
    warmup: SH_WARMUP, modifications: SH_MODS,
    exercises: [
      { id: "e1", name: "Sandbag Bear Hug Press", category: "push", sets: 4, notes: "Bear-hug a heavy sandbag at your chest. Press it overhead by any means necessary. This is messy and hard — that's the point. Aim for 6-10 reps. Make the bag heavier when it gets easy.", videoUrl: "https://www.youtube.com/results?search_query=sandbag+press+overhead", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Sandbag Over-Shoulder Toss", category: "hinge", sets: 4, notes: "Place the sandbag on the ground. Squat down, grab it, and in one explosive motion, pull it up and over one shoulder. Walk back, repeat over the other shoulder. Aim for 6-10 total. Use a proper sandbag (not loose weights). Start with a lighter bag to learn the explosive hinge pattern. Land on grass, mat, or other soft surface — not pavement.", videoUrl: "https://www.youtube.com/results?search_query=sandbag+over+shoulder+toss", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Sandbag Front-Loaded Squats", category: "legs", sets: 4, notes: "Hold the sandbag bear-hug style against your chest. Squat for reps. The front-loaded position challenges core stability and upper-back posture.", videoUrl: "https://www.youtube.com/results?search_query=sandbag+front+squat", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Bucket Suitcase Carry", category: "core", sets: 4, notes: "Hold a weighted bucket in one hand, opposite hand free. Walk forward 20–40 feet maintaining upright posture — fight the urge to lean toward the loaded side. Switch hands for next set. Hits core via anti-lateral flexion.", videoUrl: "https://www.youtube.com/results?search_query=plank+drag+exercise", is_weighted: true, is_unilateral: true, tracking_type: "distance" },
    ],
  },
  ...
  },
  {
    ...
    warmup: SH_WARMUP, modifications: SH_MODS,
    exercises: [
      { id: "e1", name: "Dumbbell Squeeze Press", category: "push", sets: 4, notes: "Hold two dumbbells together at your chest, actively squeezing them into each other. Press them up while maintaining that squeeze. This hits the inner chest hard. Aim for 6-10 reps.", videoUrl: "https://www.youtube.com/results?search_query=dumbbell+squeeze+press+form", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e2", name: "Dumbbell Seal Row", category: "pull", sets: 4, notes: "Lie face-down on an elevated bench (~18+ inches) with DBs hanging fully extended below you. Row both DBs to your chest, keeping body flat against the bench.", videoUrl: "https://www.youtube.com/results?search_query=dumbbell+seal+row+form", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Dumbbell Walking Lunge (heavy)", category: "legs", sets: 4, notes: "Hold heavy dumbbells at your sides. Take big, controlled steps forward into lunges. Keep your chest tall. Aim for 6-10 steps per leg.", videoUrl: "https://www.youtube.com/results?search_query=heavy+dumbbell+walking+lunge", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
      { id: "e4", name: "Dumbbell Suitcase Carry", category: "core", sets: 4, notes: "Hold a heavy dumbbell in ONE hand only, at your side. Walk 30-40 yards. Your core has to fight to keep you from leaning sideways. Switch hands and walk back.", videoUrl: "https://www.youtube.com/results?search_query=suitcase+carry+exercise+beginner", is_weighted: true, is_unilateral: true, tracking_type: "distance" },
    ],
  },
  {
    id: "sh-db-classic", name: "The No-Nonsense Four", type: "strength-hypertrophy", equipment: "dumbbell",
    description: "Four classic exercises that have built more muscle than anything else. Proven, simple, effective.",
    warmup: SH_WARMUP, modifications: SH_MODS,
    exercises: [
      ...
      { id: "e2", name: "Dumbbell Row", category: "pull", sets: 4, notes: "One knee and hand on a bench, other hand holds a dumbbell. Pull it up to your hip, squeezing your back. Lower with control. Aim for 6-10 reps per arm.", videoUrl: "https://www.youtube.com/results?search_query=single+arm+dumbbell+row+form+beginner", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
      { id: "e3", name: "Dumbbell Goblet Squat", category: "legs", sets: 4, notes: "Hold one dumbbell vertically at your chest. Squat as deep as you can with good form. The goblet position naturally teaches you to squat correctly. Aim for 6-10 reps.", videoUrl: "https://www.youtube.com/results?search_query=dumbbell+goblet+squat+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Dumbbell Farmer's Carry", category: "core", sets: 4, notes: "Hold a heavy dumbbell in each hand. Walk 30-40 yards with perfect posture. If you could only do one core exercise, this would be it.", videoUrl: "https://www.youtube.com/results?search_query=farmers+carry+exercise+beginner", is_weighted: true, is_unilateral: false, tracking_type: "distance" },
    ],
  },
  ...
  },
  {
    ...
    warmup: SH_WARMUP, modifications: SH_MODS,
    exercises: [
      { id: "e1", name: "Heavy Sled Push", category: "push", sets: 4, notes: "Load the sled heavy — heavier than endurance day. Push it for 20-30 yards. Your legs, chest, and arms all work. Rest 90 seconds between sets. Track the weight on the sled.", videoUrl: "https://www.youtube.com/results?search_query=heavy+sled+push+form", is_weighted: true, is_unilateral: false, tracking_type: "distance" },
      { id: "e2", name: "Barbell Pendlay Row", category: "pull", sets: 4, notes: "Bend at the hips so your back is nearly parallel to the floor. The barbell starts on the ground. Pull it explosively to your lower chest, lower it all the way back to the floor. Each rep starts from a dead stop. Aim for 6-10 reps.", videoUrl: "https://www.youtube.com/results?search_query=pendlay+row+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Barbell Front Squat (heavy)", category: "legs", sets: 4, notes: "Bar racked across the front of your shoulders, elbows high. Squat with upright torso. Use a heavier load than your standard Front Squat day.", videoUrl: "https://www.youtube.com/results?search_query=barbell+hack+squat+form", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Cable Woodchop", category: "core", sets: 4, notes: "Set the cable high. Grab the handle with both hands and pull it diagonally down and across your body to your opposite hip, rotating your torso. Control it back up. Do 8-10 per side.", videoUrl: "https://www.youtube.com/results?search_query=cable+woodchop+exercise+beginner", is_weighted: true, is_unilateral: true, tracking_type: "reps" },
    ],
  },
  {
    id: "sh-gym-classic", name: "The Big Three", type: "strength-hypertrophy", equipment: "full-gym",
    description: "Bench, squat, and row — plus a core finisher. The barbell movements that form the foundation of every serious strength program.",
    warmup: SH_WARMUP, modifications: SH_MODS,
    exercises: [
      ...
      { id: "e2", name: "Barbell Row", category: "pull", sets: 4, notes: "Stand, bend at the hips with a flat back, grip the bar just wider than shoulder-width. Pull the bar to your lower chest, squeeze your back, lower with control. Aim for 6-10 reps.", videoUrl: "https://www.youtube.com/results?search_query=barbell+row+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e3", name: "Barbell Back Squat", category: "legs", sets: 4, notes: "Bar across your upper back (not your neck), feet shoulder-width. Squat until your thighs are at least parallel to the floor, then drive up. Aim for 6-10 reps.", videoUrl: "https://www.youtube.com/results?search_query=barbell+back+squat+form+beginner", is_weighted: true, is_unilateral: false, tracking_type: "reps" },
      { id: "e4", name: "Hanging Knee Raise", category: "core", sets: 4, notes: "Hang from a pull-up bar. Raise your knees to your chest, pause, lower with control. Aim for as many as you can.", videoUrl: "https://www.youtube.com/results?search_query=hanging+knee+raise+beginner", is_weighted: false, is_unilateral: false, tracking_type: "reps" },
    ],
  },
  ...
  // ── Cardio L2 ───────────────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: "e1", name: "Brisk Walk or Easy Jog", category: "cardio", sets: 1, notes: "Walk or jog for 45-60 minutes at a pace where you could hold a conversation without gasping. That's the test — if you can't talk comfortably, slow down. If it feels too easy, walk faster, find a hill, or start jogging.", is_weighted: false, is_unilateral: false, tracking_type: "time" },
    ],
  },
  {
    ...
    warmup: L2_WARMUP, modifications: L2_MODS,
    exercises: [
      { id: "e1", name: "Trail Run/Hike", category: "cardio", sets: 1, notes: "45-90 minutes on trails. Keep a steady, sustainable pace — you should be able to talk throughout. Walk the steep hills if you need to, that's smart pacing, not weakness.", is_weighted: false, is_unilateral: false, tracking_type: "time" },
    ],
  },
  {
    ...
    warmup: L2_WARMUP, modifications: L2_MODS,
    exercises: [
      { id: "e1", name: "Steady Cycling", category: "cardio", sets: 1, notes: "45-60 minutes of cycling at moderate effort. You should feel like you could keep going for another hour. If a regular ride feels too easy, add hills, increase resistance, or ride farther. Requires a bike — stationary or outdoor.", is_weighted: false, is_unilateral: false, tracking_type: "time" },
    ],
  },
  {
    ...
    warmup: L2_WARMUP, modifications: L2_MODS,
    exercises: [
      { id: "e1", name: "Power Walk", category: "cardio", sets: 1, notes: "45-60 minutes of purposeful walking — arms swinging, good pace. If regular walking doesn't feel challenging enough, wear a backpack with some weight in it, choose a hilly route, or pick up the pace.", is_weighted: false, is_unilateral: false, tracking_type: "time" },
    ],
  },
  {
    ...
    warmup: L2_WARMUP, modifications: L2_MODS,
    exercises: [
      { id: "e1", name: "Family Walk", category: "cardio", sets: 1, notes: "Walk with your family for 45-60 minutes. Match the pace of your slowest member — this is about consistency and time on your feet, not speed. If you need more challenge, carry a child on your shoulders or wear a loaded backpack.", is_weighted: false, is_unilateral: false, tracking_type: "time" },
    ],
  },
  {
  ...
  },
  {
    ...
    warmup: L2_WARMUP, modifications: L2_MODS,
    exercises: [
      { id: "e1", name: "Steady State Rowing", category: "cardio", sets: 1, notes: "Row at a comfortable, steady pace for 30-45 minutes. Keep your stroke rate around 20-24 strokes per minute. Focus on smooth, full strokes — push with your legs first, then lean back slightly, then pull arms.", is_weighted: false, is_unilateral: false, tracking_type: "time" },
    ],
  },
  ...
  },
  {
    ...
    exercises: [
      { id: "e1", name: "Bodyweight HIIT Circuit", category: "cardio", sets: 1, notes: "Do each move for 30 seconds with 15 seconds rest between: high knees, squat jumps, mountain climbers, lateral shuffles. That's one round. Do 4-6 rounds with 60 seconds rest between rounds. You should be drenched by round 3.", is_weighted: false, is_unilateral: false, tracking_type: "time" },
    ],
  },
  {
