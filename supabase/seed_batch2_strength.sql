-- ============================================================
-- BATCH 2 — Strength Endurance + Strength Hypertrophy
-- Run after Batch 1. 38 workouts, sort_order 0–37.
...
VALUES (
  'se-bw-1', 'The Backyard Basics', 'strength-endurance', 'bodyweight',
  'No equipment, no excuses. Just you and gravity. A great place to start.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-bw-2', 'Playground Dad', 'strength-endurance', 'bodyweight',
  'Take the kids to the park. Use the park right back.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-bw-3', 'The Wake-Up Call', 'strength-endurance', 'bodyweight',
  'The one that makes you wonder why you started. Then glad you did.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-bw-4', 'The Early Riser', 'strength-endurance', 'bodyweight',
  'Quick, effective, done before the kids wake up.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-bw-5', 'Park Bench Pro', 'strength-endurance', 'bodyweight',
  'All you need is a park bench. Bring the kids.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-bw-classic', 'Back to Basics', 'strength-endurance', 'bodyweight',
  'The classics for a reason. Push-ups, pull-ups, squats, and a plank. No frills. Just results.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-diy-1', 'Sandbag Saturday', 'strength-endurance', 'household',
  'Grab that bag of rocks or sand. Nature''s free weights.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-diy-2', 'Toddler Tornado', 'strength-endurance', 'household',
  'Equipment: one willing (or unwilling) child. Ages 2-6 recommended.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-diy-3', 'Bucket Brigade', 'strength-endurance', 'household',
  'Two 5-gallon buckets filled with whatever you''ve got. Sand, gravel, water.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-diy-4', 'The Furniture Workout', 'strength-endurance', 'household',
  'Your house IS a gym. Chairs, towels, walls — everything works.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-kb-1', 'Dust Off the Bell', 'strength-endurance', 'kettlebell',
  'That kettlebell from 2020 is calling. Time to answer.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-kb-2', 'Bell Ringer', 'strength-endurance', 'kettlebell',
  'Swings, presses, and controlled effort.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-kb-3', 'Swing Shift', 'strength-endurance', 'kettlebell',
  'Built around the kettlebell swing — the single best bang-for-your-buck exercise.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-kb-classic', 'Kettlebell Essentials', 'strength-endurance', 'kettlebell',
  'The four kettlebell moves every beginner should learn. Simple, effective, and time-tested.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-db-1', 'Dumbbell Dad Circuit', 'strength-endurance', 'dumbbell',
  'Grab two dumbbells. That''s all you need.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-db-2', 'The Quick Fifteen', 'strength-endurance', 'dumbbell',
  'Light dumbbells, high reps, minimal rest. Done in 15-20 minutes.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-db-3', 'Dumbbell Grinder', 'strength-endurance', 'dumbbell',
  'Three classic moves. Light weight. Maximum reps. Full body burn.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-gym-1', 'Gym Made Simple', 'strength-endurance', 'full-gym',
  'You have access to everything. Keep it simple anyway.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-gym-2', 'The Sled Dog', 'strength-endurance', 'full-gym',
  'Push it. Pull it. Build serious work capacity.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-gym-3', 'Cable Cruiser', 'strength-endurance', 'full-gym',
  'The cable machine does everything. Three moves, full body, smooth resistance.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-gym-4', 'Machine Day', 'strength-endurance', 'full-gym',
  'Machines guide the movement for you. Perfect for beginners — just sit, adjust, and push.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'se-gym-classic', 'The Starter Pack', 'strength-endurance', 'full-gym',
  'First time in a gym? Start here. Machines and simple movements that teach the basics.',
  'Start with 3-5 minutes of light movement to get your blood flowing — a brisk walk, jog in place, or jumping jacks. Then do 10 arm circles (forward and backward), 10 bodyweight squats, and 10 leg swings per side. The goal is to feel warm and loose, not tired.',
  'If any exercise is too hard, reduce the range of motion (don''t go as deep/far) or slow down. Push-ups can be done on your knees. Squats can be done to a chair (sit down and stand up). Rows can be done more upright. There''s no shame in modifying — the goal is to move safely and build up over time.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-bw-1', 'Slow & Steady', 'strength-hypertrophy', 'bodyweight',
  'No weights? Go slow. The slower you move, the harder your muscles work.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-bw-2', 'Gravity Is Enough', 'strength-hypertrophy', 'bodyweight',
  'Advanced bodyweight variations that build real muscle. Harder than they look.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-diy-1', 'Garage Gains', 'strength-hypertrophy', 'household',
  'Your garage has more gym equipment than you think. Make the sandbag heavier this time.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-diy-2', 'Heavy Carry Day', 'strength-hypertrophy', 'household',
  'Loaded carries build everything — grip, core, legs, shoulders. Grab something heavy.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-kb-1', 'Heavy Bells', 'strength-hypertrophy', 'kettlebell',
  'Time to go heavier. Fewer reps. More weight. This is how you build muscle.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-kb-2', 'The Turkish Get-Up Day', 'strength-hypertrophy', 'kettlebell',
  'Three movements that build functional, real-world strength.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-db-1', 'The Classic', 'strength-hypertrophy', 'dumbbell',
  'Bread and butter dumbbell work. Simple. Effective. Just add weight over time.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-db-2', 'Upper Body Builder', 'strength-hypertrophy', 'dumbbell',
  'Heavy dumbbells. Controlled movements. Visible results.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-db-4', 'The Slow Burner', 'strength-hypertrophy', 'dumbbell',
  'Tempo work with dumbbells. Slow and controlled for maximum muscle growth.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-db-classic', 'The No-Nonsense Six', 'strength-hypertrophy', 'dumbbell',
  'Six classic exercises that have built more muscle than anything else. Proven, simple, effective.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-gym-1', 'Iron Therapy', 'strength-hypertrophy', 'full-gym',
  'Barbells — the original strength-building tool. Simple, heavy, effective.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-gym-2', 'Landmine & Barbell', 'strength-hypertrophy', 'full-gym',
  'The landmine setup is one of the most underused tools in any gym. Time to change that.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-gym-3', 'Power Hour', 'strength-hypertrophy', 'full-gym',
  'Compound barbell lifts. The most efficient way to build total-body strength.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-gym-4', 'Sled & Iron', 'strength-hypertrophy', 'full-gym',
  'Heavy sled work plus a barbell finisher. Total body strength.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
...
INSERT INTO workouts (id, name, type, equipment, description, warmup, modifications, exercises, sort_order)
VALUES (
  'sh-gym-classic', 'The Big Three', 'strength-hypertrophy', 'full-gym',
  'Bench, squat, and row. Three barbell movements that form the foundation of every serious strength program.',
  'Start with 5 minutes of easy cardio — walk, jog, bike, jump rope, whatever gets your heart rate up slightly. Then do 1 warm-up set of each exercise at very light weight (or bodyweight) for 10-12 reps. This primes the muscles and joints for heavier work and reduces injury risk.',
  'If an exercise is too difficult, reduce the weight first. If a movement hurts your joints, try a different grip or angle. Replace any exercise that causes pain (not muscle burn — actual joint pain). Dumbbell versions are usually easier on joints than barbell versions. If you''re unsure about form, watch the linked video before starting.',
  '[
